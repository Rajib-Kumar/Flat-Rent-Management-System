  ...
  <body>
    ...
    <div id="simpleModal" class="modal">
            <div class="modal-content">
                ...
                <option value="Land">Land</option>
                            ...
                            <label>Lift Available :</label><input type="text" id="lift" class="form-items" name="lift" placeholder="yES/nO" value="<?php echo $addLift; ?>">
                            <label>Number of Beds :</label><input type="number" id="beds" class="form-items" name="beds" placeholder="<?php echo $bed; ?>" value="<?php echo $bed; ?>">
                            <label>Number of Master Beds :</label><input type="number" id="mbeds" class="form-items" name="mbeds" placeholder="<?php echo $mstrBed; ?>" value="<?php echo $mstrBed; ?>">
                            <label>Number of Belcony :</label><input type="number" id="belcony" class="form-items" name="belcony" placeholder="<?php echo $belcony; ?>" value="<?php echo $belcony; ?>">
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Advertises - Grid 2 View | </li>
        <li class="ml-4">
...
-->
    ...
    if(stat == "Updated")
        {
            //alert("closing");
            document.location.href='advertises-g2.php';
