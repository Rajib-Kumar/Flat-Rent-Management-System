        ...
        <div id="simpleModal" class="modal">
            <div class="modal-content">
                ...
                <option value="Land">Land</option>
                            ...
                            <label>Number of Beds :</label><input type="number" id="bed" class="form-items" name="bed" placeholder="<?php echo $bed; ?>" value="<?php echo $bed; ?>" required>
                            <label>Number of Master Beds :</label><input type="number" id="mbed" class="form-items" name="mbed" placeholder="<?php echo $mstrBed; ?>" value="<?php echo $mstrBed; ?>" required>
                            <label>Number of Belcony :</label><input type="number" id="belcony" class="form-items" name="belcony" placeholder="<?php echo $belcony; ?>" value="<?php echo $belcony; ?>" required>
                    ...
                    <option value="RS">RS</option>
                            ...
                            <label>Floor Number :</label><input type="text" id="floor" class="form-items" name="floor" placeholder="Yes/No">
        ...
        <div id="profile-details" class="mycontainer">
           ...
           <div id="profile-myadds" class="mycontainer">
               ...
               <div id="profile-myaddsall" class="mycontainer">
                   can see all adds from here!
                   <a href="?seeadds"  class="Clickable"></a>
               </div>
